...
if (reset) begin
	...
	case (transmit_state)
		...
		10: begin
			...
			if(transmit_data_start == receive_data)begin
				transmit_data <= transmit_data + 1;
			end else begin
				transmit_data <= receive_data;
				transmit_data_start <= receive_data;
			end
...
if (reset) begin
	...
	case (receive_state)
		...
		2,3,4,5,6,7,8,9: begin
			receive_data[receive_state-2] <= UART_RX;
...
assign LED = receive_data;//transmit_data;
